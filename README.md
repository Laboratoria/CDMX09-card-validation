...
Obtenemos la reversa del número a verificar (que solamente contiene dígitos [0-9]); a todos los números que ocupan una posición par (*cuidado.,* si hablamos de los indices de un array serían impares) se les debe multiplicar por dos, si este número es mayor o igual a 10(e.g., 8 × 2 = 16),
debemos sumar los dígitos del resultado(e.g., 16: 1 + 6 = 7); el número a verificar será válido si
la suma de todos los dígitos es un múltiplo de 10.

![gráfica de algoritmo de Luhn](https://i.imgur.com/JagCe1Q.png)
...
Los primeros siete dígitos de todas las tarjetas corresponden con el número de emisor de la empresa o entidad financiera y el país.

Por ejemplo, las tarjetas VISA comienzan todas por 4, Mastercard tiene asignados los rangos entre 51 y 55, mientras que las tarjetas de American Express inician con 34 y 37.

Con lo anterior podrías agregar el logotipo del emisor dependiendo del número proporcionado.
